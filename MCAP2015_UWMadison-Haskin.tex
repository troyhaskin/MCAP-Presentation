...
\begin{frame}{Base Nodalization}
    \centering
    \includegraphics[height=0.5\paperheight]{WRCCS_Nodalization} \\[1em]
    \includegraphics[height=0.25\paperheight]{WRCCS_CavityNodalization}
    \vbox{}\vskip-2em
