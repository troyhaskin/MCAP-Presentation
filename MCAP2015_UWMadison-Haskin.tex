...
\begin{frame}{Interphase friction}
    \only<1>{
    \begin{itemize}
        \item MELCOR's interphase friction term was considered to account for period discrepancy
        \item Adjusted \textbf{\texttt{FL\_LME}} in piping to examine any effects
    \end{itemize}
        .
    }
    \only<2>{
...
\begin{frame} {Conclusions}
    ...
    {
    \centering
    \includegraphics[height=0.24\paperheight]{BoilingRegimes}%\vskip0em
    \hfill
